...
execute as @a[tag=create_spawn_craft] at @s run summon armor_stand ~ ~ ~ {Invisible:1,CustomNameVisible:1,CustomName:'[{"text":"Balise de Spawn"}]',NoAI:1,NoGravity:1,Tags:["SpawnPoint"]}
...
execute as @a[tag=tp_spawn_craft] run give @s minecraft:carrot_on_a_stick{display:{Name:'{"text":"Se téléporter à la balise de spawn","italic":false}'},CustomModelData:1} 2
...
execute as @a[tag=!tp_spawn,tag=!tp_spawn_after] if score @s click_carrot matches 1.. if data entity @s {SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'{"text":"Se téléporter à la balise de spawn","italic":false}'},CustomModelData:1}}} run tag @s add tp_spawn_setup
execute as @a[tag=!tp_spawn,tag=tp_spawn_after,tag=!tp_spawn_plus_after] if score @s click_carrot matches 1.. if data entity @s {SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'{"text":"Se téléporter à la balise de spawn","italic":false}'},CustomModelData:1}}} run tag @s add tp_spawn_plus
execute as @a[tag=tp_spawn_setup] run clear @s minecraft:carrot_on_a_stick{display:{Name:'{"text":"Se téléporter à la balise de spawn","italic":false}'},CustomModelData:1} 1
execute as @a[tag=tp_spawn_plus] run clear @s minecraft:carrot_on_a_stick{display:{Name:'{"text":"Se téléporter à la balise de spawn","italic":false}'},CustomModelData:1} 1
execute as @a[tag=tp_spawn_setup] run tellraw @s [{"text":"[TpToRandomEntity]","color":"red","bold":true},{"text":" Vous serez téléporté à votre balise de spawn lors de votre prochaine téléportation. Vous aurez ensuite 2 minutes de plus avant la prochaine téléportation. Si vous utilisez ensuite un autre objet comme celui-là, vous pourrez augmenter votre temps de 3 minutes avant votre prochaine téléportation.\nVeuillez patienter votre prochaine téléportation.","color":"white","bold":false}]
execute as @a[tag=tp_spawn_plus] run tellraw @s [{"text":"[TpToRandomEntity]","color":"red","bold":true},{"text":" Vous avez bien augmenté votre temps de 3 minutes avant votre prochaine téléportation. Ceci ne pourra pas se faire un deuxième
fois.","color":"white","bold":false}]
